...
<div class="card m-3">
    <div class="card-header justify-content-between">
        ...
        <div class="d-flex justify-content-between col-auto">
            <a href=" {{ route('paciente.edit', ['paciente' => $paciente]) }}" class="btn me-2 btn-secondary w-100">
            ...
            <form id="form_{{$paciente->id}}" method="post" action="{{ route('paciente.destroy', ['paciente' => $paciente]) }}">
                ...
                <a href="#" onclick="document.getElementById('form_{{$paciente->id}}').submit()" class="btn btn-danger w-100">
