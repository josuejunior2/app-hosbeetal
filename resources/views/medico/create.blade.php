        ...
        <div class="row g-3 mb-4">
            <div class="col-md">
                <div class="mb-3">
                    ...
                    <div class="col">
                        <input type="text" name="especialidade" id="especialidade" class="form-control" value="{{ old('especialidade', '') }}" autocomplete="off"/>
                ...
                <div class="mb-3">
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <td>
                                <input type="text" name="numero_crm" value="{{ old('numero_crm', '') }}" id="numero_crm" class="form-control" autocomplete="off" />
